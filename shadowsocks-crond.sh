...
name=(Shadowsocks Shadowsocks-Python ShadowsocksR Shadowsocks-Go Shadowsocks-libev Shadowsocks-manager)
path=/var/log
[[ ! -d ${path} ]] && mkdir -p ${path}
...
shadowsocks_init[5]=/etc/init.d/shadowsocks-manager
